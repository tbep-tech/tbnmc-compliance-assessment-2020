...
Lastly, annual hydrologic conditions within all four bay segments in `r yrval` were estimated to exceed 1992-1994 levels. Therefore, hydrologic adjustments for evaluating compliance with load allocations/permitting targets should be applied for the Old Tampa Bay, Hillsborough Bay, Middle Tampa Bay, and Lower Tampa Bay segments [@tbep0512;@tbep0316]. The estimated hydrologic loads for each bay segment relative to observed 1992-1994 levels are indicated in the table below. The associated compliance load adjustment factors (if applicable) are also specified. A tool to calculate the hydrologic estimates and adjustment factors by bay segment is now available online through an interactive dashboard (https://shiny.tbeptech.org/tbnmc_hydrologic_estimates/).
